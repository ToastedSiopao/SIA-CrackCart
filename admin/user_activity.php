...
<head>
    ...
    <link href="admin-styles.css?v=1.5" rel="stylesheet">
</head>
<body>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($user['ACCOUNT_STATUS'] === 'ACTIVE'): ?>
                                                <button class="btn btn-warning btn-sm" onclick="updateUserStatus(<?php echo $user['USER_ID']; ?>, 'INACTIVE')">Deactivate</button>
                                            <?php else: ?>
